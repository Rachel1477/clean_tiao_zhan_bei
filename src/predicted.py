...
def main():
    ...
    CONFIG = {
        ...
        'output_dir': './online_prediction_results',
        'img_size': (224, 224),
    ...
    val_dataset = SequentialMultimodalRadarDataset(data_root_dir=CONFIG['data_root_dir'], data_split=CONFIG['val_data_dir_name'], max_seq_len=1000) # max_seq_len设大一点确保加载所有点
